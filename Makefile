...
# Source files
SRC_FILES := ./utils/tensor.cpp ./utils/data_structure.cpp ./utils/printer.cpp ./utils/data_encoding.cpp ./grammar/grammar.cpp ./grammar/grammar_parser.cpp utils/data_accessing.cpp utils/application_io.cpp
HEADER_FILES := ./utils/tensor.hpp ./utils/data_structure.hpp ./utils/printer.hpp ./utils/data_encoding.h ./grammar/grammar.hpp ./grammar/grammar_parser.hpp utils/data_accessing.hpp utils/application_io.hpp
MAIN_FILE = main.cpp
