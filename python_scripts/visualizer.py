def plot_distribution_of_record_items(key_name, seizures, preepileptic, normal):
...
def box_plot_record_items(key_name, seizures, preepileptic, normal):
...
def plot_all_graph(key_name, seizures, preepileptic, normal):
    plot_distribution_of_record_items(key_name, seizures, preepileptic, normal)
    box_plot_record_items(key_name, seizures, preepileptic, normal)